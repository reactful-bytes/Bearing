    ...
    sections: [
      {
        ...
        body: 'Bearing stores account details such as email, display name, timezone, and locale, plus the events, goals, tasks, and notes you choose to save. Passwords are handled by Firebase Authentication and are not stored in Bearing application records.',
      },
      {
