...
export type PremiumFeature =
  'premium_overview' | 'ai_goal_builder' | 'external_calendar_integrations';
...
const PREMIUM_PAYWALL_COPY: Record<PremiumFeature, PremiumPaywallCopy> = {
  premium_overview: {
    ...
    body: 'Premium unlocks the AI goal builder assistant plus Google and Microsoft calendar integrations inside the app.',
    highlights: [
  ...
  external_calendar_integrations: {
    ...
    body: 'Use Premium to connect Google and Microsoft calendars for mirrored sync, calendar selection, and connection diagnostics.',
    highlights: [
