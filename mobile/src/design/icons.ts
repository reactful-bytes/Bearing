...
export const icons = {
  ...
  eyeOff: svg([
    {
      d: 'm3 3 18 18M10.6 6.2A11.2 11.2 0 0 1 12 6c6.5 0 10 6 10 6a18.3 18.3 0 0 1-3.1 3.8M6.2 6.2C3.7 8 2 12 2 12s3.5 6 10 6a10.7 10.7 0 0 0 4.2-.8M9.9 9.9a3 3 0 0 0 4.2 4.2',
    },
  ]),
  tasks: svg(
