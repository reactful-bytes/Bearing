...
export const icons = {
  back: { kind: 'image', source: require('../../assets/icon-library/back.png'), tintable: false },
  calendar: {
    kind: 'image',
    source: require('../../assets/icon-library/calendar.png'),
    tintable: false,
  },
  close: { kind: 'image', source: require('../../assets/icon-library/close.png'), tintable: false },
  create: {
    kind: 'image',
    source: require('../../assets/icon-library/create.png'),
    tintable: false,
  },
  edit: { kind: 'image', source: require('../../assets/icon-library/edit.png'), tintable: false },
  focus: { kind: 'image', source: require('../../assets/icon-library/focus.png'), tintable: false },
  goal: { kind: 'image', source: require('../../assets/icon-library/goal.png'), tintable: false },
  idea: { kind: 'image', source: require('../../assets/icon-library/idea.png'), tintable: false },
  more: { kind: 'image', source: require('../../assets/icon-library/more.png'), tintable: false },
  note: { kind: 'image', source: require('../../assets/icon-library/note.png'), tintable: false },
  profile: {
    kind: 'image',
    source: require('../../assets/icon-library/profile.png'),
    tintable: false,
  },
  search: {
    kind: 'image',
    source: require('../../assets/icon-library/search.png'),
    tintable: false,
  },
  task: { kind: 'image', source: require('../../assets/icon-library/task.png'), tintable: false },
  timeline: {
    kind: 'image',
    source: require('../../assets/icon-library/timeline.png'),
    tintable: false,
  },
  plan: { kind: 'image', source: require('../../assets/icon-library/plan.png'), tintable: false },
  goals: { kind: 'image', source: require('../../assets/icon-library/goals.png'), tintable: false },
  notes: { kind: 'image', source: require('../../assets/icon-library/note.png'), tintable: false },
  bearingMark: {
    kind: 'image',
