...
| Cloud Firestore                             | Canonical app data and temporary AI coordination            | Profile, Bearing events, goals, tasks, notes, subscription entitlement, temporary AI operations/locks                           | Account data deleted by callable; AI operations target 24-hour TTL; locks are deleted on completion/deletion | Verify production region, rules, indexes, TTL, deletion, and DPA                     |
